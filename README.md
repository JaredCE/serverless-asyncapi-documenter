# AsyncAPI Generator for serverless

<p>
  <a href="https://www.serverless.com">
    <img src="http://public.serverless.com/badges/v3.svg">
  </a>
  <a href="https://www.npmjs.com/package/serverless-asyncapi-documenter">
    <img src="https://img.shields.io/npm/v/serverless-asyncapi-documenter.svg?style=flat-square">
  </a>
  <a href="https://github.com/JaredCE/serverless-asyncapi-documenter/actions/workflows/node.yml">
    <img src="https://github.com/JaredCE/serverless-asyncapi-documenter/actions/workflows/node.yml/badge.svg">
  </a>
</p>



This will generate an AsyncAPI file for you from your serverless file.  This currently works for `websocket` configurations.  If you're looking for an OpenAPI v3 generator for the serverless framework, please see my other package: https://www.npmjs.com/package/serverless-openapi-documenter
...
**Using npm:**
```bash
npm install --save-dev serverless-asyncapi-documenter
```
...
To Run: `serverless asyncapi generate -o openapi.json -f json`

Options:

```
--output                -o  What filename the AsyncAPI documentation should output under. Default: asyncapi.json
--format                -f  Whether to output the AsyncAPI documentation as json or yaml. Default: json
--indent                -i  File indentation in spaces. Default: 2enerated openAPI documentation), in json only, if passed in. Default postman.json
```
